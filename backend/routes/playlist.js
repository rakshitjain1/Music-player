...
// // / something1/something2/something3 -> exact match needed to go to this api
// //If we are doing /playlist/get/:playlistId (focus on teh :) -> this means
// // that playlistId is now a variable to which we can assign any value
// router.get("/get/playlist/:playlistId",passport.authenticate("jwt", {session: false}),
//     async (req,res)=>{
//         // This concept is called req-params
//         //We cannot take the data from the req.body in the get request 
...
//         }
//         // Step 1: Check if currentser owns the playlist or is a collaborator
